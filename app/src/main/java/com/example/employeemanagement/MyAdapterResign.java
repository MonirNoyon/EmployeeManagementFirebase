...
public class MyAdapterResign extends RecyclerView.Adapter<MyViewHolderLeave> {
    ...
    public MyAdapterResign(ArrayList<UploadFile> nameArray, Context context) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolderLeave holder, int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        databaseReference = FirebaseDatabase.getInstance().getReference("Upload_resignFile");
        ...
        holder.download.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                reference = FirebaseStorage.getInstance().getReference("Upload_resignFile");
