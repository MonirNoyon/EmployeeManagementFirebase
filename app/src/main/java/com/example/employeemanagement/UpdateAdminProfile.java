...
public class UpdateAdminProfile extends Fragment {

    private static final int SELECT_FILE = 455;
    View view;
    ImageView profile, signeture, qrcode;
    EditText name, empid, blood, mobileno, address, workplace;
    Button update;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.updateadmin_profile,container,false);
        initReference();
        imageUpdate();
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                if (name.getText().toString().equals("") || empid.getText().toString().equals("") || blood.getText().toString().equals("") ||
                        mobileno.getText().toString().equals("") ||  address.getText().toString().equals("") || workplace.getText().toString().equals("")) {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    profile_storage.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            reference.child("-M4UvF6TLIrCyrIN3ZWn").updateChildren(update_prof);
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    sign_storage.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            reference.child("-M4UvF6TLIrCyrIN3ZWn").updateChildren(update_sign);
                                        }
                                    });
                                }
                            });
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    qr_storage.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            reference.child("-M4UvF6TLIrCyrIN3ZWn").updateChildren(update_qr);
                                        }
                                    });
                                }
                            });
                    ...
                    reference.child("-M4UvF6TLIrCyrIN3ZWn").updateChildren(updates);
