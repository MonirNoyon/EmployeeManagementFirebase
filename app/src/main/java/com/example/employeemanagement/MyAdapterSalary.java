...
public class MyAdapterSalary extends RecyclerView.Adapter<MyViewHolderSalary> implements Filterable {

    ArrayList<UploadData> name;
    Context context;

    public MyAdapterSalary(ArrayList<UploadData> name, Context context) {
        this.name = name;
    ...
    public void onBindViewHolder(@NonNull MyViewHolderSalary holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(),SingleSalaryActivity.class);
